...
public static class SimplifiedMetadataExtensions
{
    ...
    /// <param name="sourceMetadata">The metadata providing the validation context</param>
    ...
    /// </remarks>
    public static void ValidateKeys<T, TOther>(this Metadata<T> sourceMetadata, Dictionary<string, Key> allKeys, RoleKeys roleKeys, Metadata<TOther> otherMetadata)
        ...
        where TOther : ISerializeProvider<TOther>, IDeserializeProvider<TOther>
    {
        ...
        foreach (var keyId in roleKeys.KeyIds)
        {
            ...
            if (key.VerifyKeySignature(matchingSignature.Sig, signedBytes))
            {
                verifiedSignatures++;
            }
            else
    ...
    /// </remarks>
    public static byte[] GetSignedBytes<T>(this Metadata<T> sourceMetadata)
        where T : ISerializeProvider<T>, IDeserializeProvider<T>
    {
    ...
    /// <param name="rootMetadata">The root metadata containing key assignments</param>
    ...
    /// </remarks>
    public static void VerifyRole<TOther>(this Metadata<Root> rootMetadata, string roleType, Metadata<TOther> otherMetadata)
        where TOther : ISerializeProvider<TOther>, IDeserializeProvider<TOther>
    {
    ...
    /// </summary>
    /// <param name="targetsMetadata">The targets metadata containing delegation configuration</param>
    ...
    /// </remarks>
    public static void VerifyDelegatedRole(this Metadata<Targets> targetsMetadata, string roleType, Metadata<Targets> otherMetadata)
    {
    ...
    /// </summary>
    /// <param name="key">The key to compute an identifier for</param>
    ...
    /// </remarks>
    public static string GetKeyId(this Key key)
    {
    ...
    /// </remarks>
    public static bool VerifyKeySignature(this Key key, string signature, byte[] signedBytes)
    {
        try
        {
