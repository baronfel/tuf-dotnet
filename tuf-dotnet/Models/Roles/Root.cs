...
public record Root(SemanticVersion SpecVersion, bool? ConsistentSnapshot, uint Version, DateTimeOffset Expires, Dictionary<KeyId, Keys.IKey> Keys, RootRoles Roles) : RoleBase(SpecVersion, Version, Expires);